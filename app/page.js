  ...
  return (
    <main className="m-8 mx-auto max-w-4xl px-8">
      ...
      <ul className="p-4 text-2xl font-bold">
          ...
          <li>
            <Link href="./week-8/" className={pageStyle}>Week 8 Assignment</Link>
          </li>
          <li>
            <Link href="./week-9/" className={pageStyle}>Week 9 Assignment</Link>
          </li>
          <li>
            <Link href="./week-10/" className={pageStyle}>Week 10 Assignment</Link>
          </li>
      </ul>
    </main>
  );
